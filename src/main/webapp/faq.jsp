            ...
            <div class="accordion" id="faqAccordion">
                ...
                <div class="card faq-card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#faqAccordion">
                        <div class="card-body faq-card-body">
                            <p>Once you find a Car that matches your qualifications, click on the "Apply Now" button on the job listing page. You will be prompted to upload your resume and cover letter. After submission, your application will be sent to the employer for review.</p>
                        </div>
                    </div>
                </div>
