...
<div class="container my-4">
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center text-primary mb-4">Available Car</h5>
            ...
            <div class="alert alert-warning text-center">
                <strong><i class="fas fa-exclamation-triangle"></i> No Cars Available</strong>
            </div>
            <%
            } else {
                %>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="far fa-clipboard fa-2x"></i> Cars Details
                    </div>
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="one_view.jsp?id=<%=j.getId()%>" class="btn btn-success">View Cars</a>
                        </div>
                    </div>
                </div>
                <%
